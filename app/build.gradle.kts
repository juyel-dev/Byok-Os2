  ...
  signingConfigs {
    ...
    getByName("debug") {
      ...
      if (keystoreFile.exists()) {
        ...
        // Fallback to the default Android debug keystore logic automatically generated by Gradle
        // No explicit storeFile means rely on default Android Gradle Plugin debug keystore!
      }
    }
  }
